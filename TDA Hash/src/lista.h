...
void *lista_buscar_elemento(lista_t *lista, int (*comparador)(void *, void *),
			    void *contexto);
/**
 * Quita y devuelve el primer elemento de la lista que cumple la condición
 * comparador(elemento, contexto) == 0.
 *
 * Si no existe el elemento devuelve NULL.
 */
...
/**
 * Reemplaza el elemento recibido por el primer elemento de la lista que cumple la condición
 * comparador(elemento, contexto) == 0.
 *
 * Si no existe el elemento, se inserta al final.
 */
void *lista_reemplazar_elemento(lista_t *lista, void *elemento, int (*comparador)(void *, void *), void *context);
