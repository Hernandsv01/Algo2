...
#define TAMANIO_VECTOR_PRUEBA 6
...
//creacion
void se_crea_un_arbol_exitosamente(){
...
//insercion 
void se_inserta_un_elemento_en_arbol_obtengo_arbol_con_un_elemento(){
  abb_t *arbol = abb_crear(comparador);
...
void se_insertan_elementos_en_arbol_obtengo_arbol_con_elementos(){
  abb_t *arbol = abb_crear(comparador);
  ...
  pa2m_afirmar(!abb_vacio(arbol),"Un arbol con tres elementos no se encuentra vacio.");
...
//quitar & buscar
void se_quitan_elementos_de_un_arbol_exitosamente(){
...
void se_buscan_elementos_dentro_de_un_arbol_obtengo_elementos_correspondientes(){
abb_t *abb = abb_crear(comparador);
  cosa_t *cosa_uno = crear_cosa(10);
  cosa_t *cosa_dos = crear_cosa(5);
  cosa_t *cosa_tres = crear_cosa(20);
...
void pruebas_recorrido_con_cada_elemento_funcion_true_retornan_los_tres_recorridos_igual_cantidad(){
  abb_t *abb = abb_crear(comparador);
...
void pruebas_recorrido_con_cada_elemento(){
  abb_t *abb = abb_crear(comparador);
  cosa_t *cosa_uno = crear_cosa(8);
  cosa_t *cosa_dos = crear_cosa(4);
  cosa_t *cosa_tres = crear_cosa(2);
...
//recorrer 
//inorden
void se_recorre_un_arbol_vacio_obtengo_cero_elementos(){
  abb_t *abb = abb_crear(comparador);
  void *array[TAMANIO_VECTOR_PRUEBA];
  size_t cantidad_recorrida_inorden = abb_recorrer(abb, INORDEN, array, TAMANIO_VECTOR_PRUEBA);
  size_t cantidad_recorrida_preorden = abb_recorrer(abb, PREORDEN, array, TAMANIO_VECTOR_PRUEBA);
  size_t cantidad_recorrida_postorden = abb_recorrer(abb, POSTORDEN, array, TAMANIO_VECTOR_PRUEBA);
...
void se_recorre_un_arbol_inorden_con_elementos_obtengo_la_cantidad_de_elementos_correspondientes(){
  abb_t *abb = abb_crear(comparador);
  void *array[TAMANIO_VECTOR_PRUEBA];
  ...
  size_t recorridos_inorden = abb_recorrer(abb, INORDEN, array, TAMANIO_VECTOR_PRUEBA);
  pa2m_afirmar(recorridos_inorden == TAMANIO_VECTOR_PRUEBA, "Recorrer el arbol INORDEN retorna la cantidad de elementos recorridos correspondiente.");
...
void se_recorre_un_arbol_preorden_con_elementos_obtengo_la_cantidad_de_elementos_correspondientes(){
  abb_t *abb = abb_crear(comparador);
  void *array[TAMANIO_VECTOR_PRUEBA];
  cosa_t *diez = crear_cosa(10);
  cosa_t *siete = crear_cosa(7);
  ...
  size_t recorridos_inorden = abb_recorrer(abb, PREORDEN, array, TAMANIO_VECTOR_PRUEBA);
  pa2m_afirmar(recorridos_inorden == TAMANIO_VECTOR_PRUEBA, "Recorrer el arbol PREORDEN retorna la cantidad de elementos recorridos correspondiente.");
...
void se_recorre_un_arbol_postorden_con_elementos_obtengo_la_cantidad_de_elementos_correspondientes(){
  abb_t *abb = abb_crear(comparador);
  void *array[TAMANIO_VECTOR_PRUEBA];
  cosa_t *diez = crear_cosa(10);
  cosa_t *siete = crear_cosa(7);
  ...
  size_t recorridos_inorden = abb_recorrer(abb, POSTORDEN, array, TAMANIO_VECTOR_PRUEBA);
  pa2m_afirmar(recorridos_inorden == TAMANIO_VECTOR_PRUEBA, "Recorrer el arbol PREORDEN retorna la cantidad de elementos recorridos correspondiente.");
  pa2m_afirmar((cosa_t *)(array[0])== cuatro, "El primer elemento del array es el correspondiente.");
...
int main(){
  ...
  se_crea_un_arbol_exitosamente();

  pa2m_nuevo_grupo("Pruebas de insercion de un elemento");
  se_inserta_un_elemento_en_arbol_obtengo_arbol_con_un_elemento();
  pa2m_nuevo_grupo("Pruebas de insercion de tres elementos");
  se_insertan_elementos_en_arbol_obtengo_arbol_con_elementos();

  pa2m_nuevo_grupo("Pruebas de quitar elementos");
  se_quitan_elementos_de_un_arbol_exitosamente();

  pa2m_nuevo_grupo("Pruebas de busqueda de elementos");
  se_buscan_elementos_dentro_de_un_arbol_obtengo_elementos_correspondientes();

  pa2m_nuevo_grupo("Pruebas de abb con cada elemento");
  pruebas_recorrido_con_cada_elemento_funcion_true_retornan_los_tres_recorridos_igual_cantidad();
  pruebas_recorrido_con_cada_elemento();

  pa2m_nuevo_grupo("Pruebas de abb recorrer");
  se_recorre_un_arbol_vacio_obtengo_cero_elementos();
  se_recorre_un_arbol_inorden_con_elementos_obtengo_la_cantidad_de_elementos_correspondientes();
  se_recorre_un_arbol_preorden_con_elementos_obtengo_la_cantidad_de_elementos_correspondientes();
  se_recorre_un_arbol_postorden_con_elementos_obtengo_la_cantidad_de_elementos_correspondientes();
